 ...
 * Requests
 *
 * @ORM\Table(name="requests", indexes={@ORM\Index(name="service_categories_service_category_id_idx", columns={"request_service_category_id"}), @ORM\Index(name="documents_document_id_idx", columns={"request_document_id"}), @ORM\Index(name="module_workflow_statuses_status_id_idx", columns={"request_status_id"})})
 * @ORM\Entity
 */
class Requests
{
